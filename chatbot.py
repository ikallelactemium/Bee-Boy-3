...
if "auth" not in st.session_state :
    ...
    st.logo("images/Actemium.png",link="https://www.actemium.fr/implantations/actemium-maintenance-toulouse/presentation/", icon_image="images/Actemium_logo_01.png")
